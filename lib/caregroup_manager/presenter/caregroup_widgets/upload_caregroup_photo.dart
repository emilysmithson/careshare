...
class UploadCaregroupPhotoWidget extends StatefulWidget {
  final void Function(File imageUrl) imagePickFn;
  final String? currentPhotoUrl;
  const UploadCaregroupPhotoWidget({
    Key? key,
  ...
  @override
  State<UploadCaregroupPhotoWidget> createState() =>
      _UploadCaregroupPhotoWidgetState();
}

class _UploadCaregroupPhotoWidgetState extends State<UploadCaregroupPhotoWidget> {
  File? _pickedImage;
