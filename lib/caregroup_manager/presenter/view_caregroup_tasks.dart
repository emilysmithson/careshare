          ...
          child: Column(
            children: [
              ...
              TaskSection(
                ...
                careTaskList: _taskList
                    .where((element) =>
                        ...
                        element.assignedTo == BlocProvider.of<MyProfileCubit>(context).myProfile.id)
                    .toList(),
              ),
              GestureDetector(
                onTap: () {
              ...
              TaskSection(
                ...
                careTaskList: _taskList.where((element) => element.taskStatus == TaskStatus.completed).toList(),
              ),
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(
