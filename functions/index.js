...
exports.createTask = functions.https.onCall(async (data) => {
  ...
  admin.messaging().sendToTopic("task_created", {
    notification:
      {
        title: data["creater_name"] + " has created a task: " +
        data["task_title"],
        body: data["creater_name"] + " has created a task: " +
        data["task_title"] + " at " + data["date_time"],
    ...
    notification:
      {
        ...
        body: data["kudos_assigner_name"] + " has assigned you a new task: " +
        data["task_title"],
        clickAction: "FLUTTER_NOTIFICATION_CLICK",
      },
    data: {
...
// Send a message to everyone
  admin.messaging().sendToTopic("task_completed", {
    notification:
      {
        title: data["completer_name"] + " has completed a task: " +
        data["task_title"],
        body: data["completer_name"] + " has completed a task: " +
        data["task_title"] + " at " + data["date_time"],
        clickAction: "FLUTTER_NOTIFICATION_CLICK",
      },
    data: {
